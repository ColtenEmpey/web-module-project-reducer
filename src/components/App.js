...
import { applyNumber, changeOperation, clear, memoryAdd, memoryApply, momoryClear } from '../actions';
...
function App() {
  ...
  const handleNumberClick = (number) =>{
   ...
   const handleOporatorClick = (type) =>{
     dispatch(changeOperation(type))
   }
   const handleClear = () =>{
     dispatch(clear())
   }
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"+"} onClick={()=> handleOporatorClick("+")}/>
              <CalcButton value={"*"} onClick={()=> handleOporatorClick("*")}/>
              <CalcButton value={"-"} onClick={()=> handleOporatorClick("-")}/>
            </div>
